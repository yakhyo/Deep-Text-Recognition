...
from net.nn import TPS_SpatialTransformerNetwork, ResNet_FeatureExtractor, BidirectionalLSTM, Attention
...
class Model(nn.Module):
    ...
    def __init__(self, opt):
        ...
        if opt.Prediction == 'Attn':
            ...
            raise Exception('Prediction is not specified to Attn')
